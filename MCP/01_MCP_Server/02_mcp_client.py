...
prompt = "What is the time in country where messi visited in Dec 2025?"
...
async def chat(query):
    ...
    messages.append(SystemMessage(content= f"You are an expert file system assistant and have access to datetime in UTC and web search. All file operations in {MCP_FOLDER}"))
