# pip install -U langgraph langchain-anthropic pydantic python-dotenv langsmith
...
# Haiku 4.5 is the cheapest/fastest Claude model and still accepts temperature
# (unlike Opus 4.8). max_tokens is required by ChatAnthropic.
model = ChatAnthropic(model="claude-haiku-4-5", temperature=0, max_tokens=4096)
